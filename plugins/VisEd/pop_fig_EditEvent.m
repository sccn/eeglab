...
if nargin < 5
    ...
    if ~isfield(g.eventedit, 'SelEventStruct');
        ...
        results=inputgui( ...
            ...
            ...7
            {'Style', 'text', 'tag', 'ChanIndexText','string', 'Channel selection:'}, ...
            {'Style', 'popup', 'tag', 'ChanLabelList','string', {g.eloc_file.labels}, 'value', g.eventedit.ChanIndex}, ...
            }, ...
        ...
        if results{4}==1;
            g.eventedit.ChanIndex=results{5};
