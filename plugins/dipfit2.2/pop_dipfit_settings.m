...
if nargin < 2
    ...
    elements  = { ...
        ...
        { 'style' 'edit'        'string' template_models{1}{1}  'tag'      'model' 'userdata' 'editable' 'enable' 'off'} ...
        ...
        { 'style' 'listbox'     'string' 'spherical (head radius 85 mm)|MNI' 'tag' 'coord' ...
          'value' fastif(strcmpi(template_models{1}{2},'MNI'),2,1)  'userdata' 'editable' 'enable' 'off'} ...
        ...
        { 'style' 'edit'        'string' template_models{1}{4} 'tag'      'meg'  'userdata' 'editable' 'enable' 'off'} ...
