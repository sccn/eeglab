...
if nargin < 2
    ...
    elseif isfield(EEG.dipfit, 'hdmfile')
        ...
        str = [ 'Dipole information and settings are present in the dataset. ' ...
                'Keep or erase this old dipole information and locations?' ];
        tmpButtonName=questdlg2( strmultiline(str, 60), 'Old DIPFIT structure', 'Keep', 'Erase', 'Keep');
        if strcmpi(tmpButtonName, 'Keep'), return; end;       
    end;    
    ...
    elements  = { ...
        ...
        { 'style' 'text'        'string' 'Template channel locs. file' } ...
        ...
        { 'style' 'text'        'string' 'Chans. to omit in dipole fitting' } ...
        ...
        { 'style' 'text'        'string' '(Tip: In the channel editor ''Set head radius'' to 85).' } ...
                };
