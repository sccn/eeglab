...
planar = {
    'MEG 0113'    'MEG 0112'    'MEG 0113+0112'    % 'MEG 0111'
    'MEG 0122'    'MEG 0123'    'MEG 0122+0123'    % 'MEG 0121'
    'MEG 0132'    'MEG 0133'    'MEG 0132+0133'    % 'MEG 0131'
    'MEG 0143'    'MEG 0142'    'MEG 0143+0142'    % 'MEG 0141'
    'MEG 0213'    'MEG 0212'    'MEG 0213+0212'    % 'MEG 0211'
    'MEG 0222'    'MEG 0223'    'MEG 0222+0223'    % 'MEG 0221'
    'MEG 0232'    'MEG 0233'    'MEG 0232+0233'    % 'MEG 0231'
    'MEG 0243'    'MEG 0242'    'MEG 0243+0242'    % 'MEG 0241'
    'MEG 0313'    'MEG 0312'    'MEG 0313+0312'    % 'MEG 0311'
    'MEG 0322'    'MEG 0323'    'MEG 0322+0323'    % 'MEG 0321'
    'MEG 0333'    'MEG 0332'    'MEG 0333+0332'    % 'MEG 0331'
    'MEG 0343'    'MEG 0342'    'MEG 0343+0342'    % 'MEG 0341'
    'MEG 0413'    'MEG 0412'    'MEG 0413+0412'    % 'MEG 0411'
    'MEG 0422'    'MEG 0423'    'MEG 0422+0423'    % 'MEG 0421'
    'MEG 0432'    'MEG 0433'    'MEG 0432+0433'    % 'MEG 0431'
    'MEG 0443'    'MEG 0442'    'MEG 0443+0442'    % 'MEG 0441'
    'MEG 0513'    'MEG 0512'    'MEG 0513+0512'    % 'MEG 0511'
    'MEG 0523'    'MEG 0522'    'MEG 0523+0522'    % 'MEG 0521'
    'MEG 0532'    'MEG 0533'    'MEG 0532+0533'    % 'MEG 0531'
    'MEG 0542'    'MEG 0543'    'MEG 0542+0543'    % 'MEG 0541'
    'MEG 0613'    'MEG 0612'    'MEG 0613+0612'    % 'MEG 0611'
    'MEG 0622'    'MEG 0623'    'MEG 0622+0623'    % 'MEG 0621'
    'MEG 0633'    'MEG 0632'    'MEG 0633+0632'    % 'MEG 0631'
    'MEG 0642'    'MEG 0643'    'MEG 0642+0643'    % 'MEG 0641'
    'MEG 0713'    'MEG 0712'    'MEG 0713+0712'    % 'MEG 0711'
    'MEG 0723'    'MEG 0722'    'MEG 0723+0722'    % 'MEG 0721'
    'MEG 0733'    'MEG 0732'    'MEG 0733+0732'    % 'MEG 0731'
    'MEG 0743'    'MEG 0742'    'MEG 0743+0742'    % 'MEG 0741'
    'MEG 0813'    'MEG 0812'    'MEG 0813+0812'    % 'MEG 0811'
    'MEG 0822'    'MEG 0823'    'MEG 0822+0823'    % 'MEG 0821'
    'MEG 0913'    'MEG 0912'    'MEG 0913+0912'    % 'MEG 0911'
    'MEG 0923'    'MEG 0922'    'MEG 0923+0922'    % 'MEG 0921'
    'MEG 0932'    'MEG 0933'    'MEG 0932+0933'    % 'MEG 0931'
    'MEG 0942'    'MEG 0943'    'MEG 0942+0943'    % 'MEG 0941'
    'MEG 1013'    'MEG 1012'    'MEG 1013+1012'    % 'MEG 1011'
    'MEG 1023'    'MEG 1022'    'MEG 1023+1022'    % 'MEG 1021'
    'MEG 1032'    'MEG 1033'    'MEG 1032+1033'    % 'MEG 1031'
    'MEG 1043'    'MEG 1042'    'MEG 1043+1042'    % 'MEG 1041'
    'MEG 1112'    'MEG 1113'    'MEG 1112+1113'    % 'MEG 1111'
    'MEG 1123'    'MEG 1122'    'MEG 1123+1122'    % 'MEG 1121'
    'MEG 1133'    'MEG 1132'    'MEG 1133+1132'    % 'MEG 1131'
    'MEG 1142'    'MEG 1143'    'MEG 1142+1143'    % 'MEG 1141'
    'MEG 1213'    'MEG 1212'    'MEG 1213+1212'    % 'MEG 1211'
    'MEG 1223'    'MEG 1222'    'MEG 1223+1222'    % 'MEG 1221'
    'MEG 1232'    'MEG 1233'    'MEG 1232+1233'    % 'MEG 1231'
    'MEG 1243'    'MEG 1242'    'MEG 1243+1242'    % 'MEG 1241'
    'MEG 1312'    'MEG 1313'    'MEG 1312+1313'    % 'MEG 1311'
    'MEG 1323'    'MEG 1322'    'MEG 1323+1322'    % 'MEG 1321'
    'MEG 1333'    'MEG 1332'    'MEG 1333+1332'    % 'MEG 1331'
    'MEG 1342'    'MEG 1343'    'MEG 1342+1343'    % 'MEG 1341'
    'MEG 1412'    'MEG 1413'    'MEG 1412+1413'    % 'MEG 1411'
    'MEG 1423'    'MEG 1422'    'MEG 1423+1422'    % 'MEG 1421'
    'MEG 1433'    'MEG 1432'    'MEG 1433+1432'    % 'MEG 1431'
    'MEG 1442'    'MEG 1443'    'MEG 1442+1443'    % 'MEG 1441'
    'MEG 1512'    'MEG 1513'    'MEG 1512+1513'    % 'MEG 1511'
    'MEG 1522'    'MEG 1523'    'MEG 1522+1523'    % 'MEG 1521'
    'MEG 1533'    'MEG 1532'    'MEG 1533+1532'    % 'MEG 1531'
    'MEG 1543'    'MEG 1542'    'MEG 1543+1542'    % 'MEG 1541'
    'MEG 1613'    'MEG 1612'    'MEG 1613+1612'    % 'MEG 1611'
    'MEG 1622'    'MEG 1623'    'MEG 1622+1623'    % 'MEG 1621'
    'MEG 1632'    'MEG 1633'    'MEG 1632+1633'    % 'MEG 1631'
    'MEG 1643'    'MEG 1642'    'MEG 1643+1642'    % 'MEG 1641'
    'MEG 1713'    'MEG 1712'    'MEG 1713+1712'    % 'MEG 1711'
    'MEG 1722'    'MEG 1723'    'MEG 1722+1723'    % 'MEG 1721'
    'MEG 1732'    'MEG 1733'    'MEG 1732+1733'    % 'MEG 1731'
    'MEG 1743'    'MEG 1742'    'MEG 1743+1742'    % 'MEG 1741'
    'MEG 1813'    'MEG 1812'    'MEG 1813+1812'    % 'MEG 1811'
    'MEG 1822'    'MEG 1823'    'MEG 1822+1823'    % 'MEG 1821'
    'MEG 1832'    'MEG 1833'    'MEG 1832+1833'    % 'MEG 1831'
    'MEG 1843'    'MEG 1842'    'MEG 1843+1842'    % 'MEG 1841'
    'MEG 1912'    'MEG 1913'    'MEG 1912+1913'    % 'MEG 1911'
    'MEG 1923'    'MEG 1922'    'MEG 1923+1922'    % 'MEG 1921'
    'MEG 1932'    'MEG 1933'    'MEG 1932+1933'    % 'MEG 1931'
    'MEG 1943'    'MEG 1942'    'MEG 1943+1942'    % 'MEG 1941'
    'MEG 2013'    'MEG 2012'    'MEG 2013+2012'    % 'MEG 2011'
    'MEG 2023'    'MEG 2022'    'MEG 2023+2022'    % 'MEG 2021'
    'MEG 2032'    'MEG 2033'    'MEG 2032+2033'    % 'MEG 2031'
    'MEG 2042'    'MEG 2043'    'MEG 2042+2043'    % 'MEG 2041'
    'MEG 2113'    'MEG 2112'    'MEG 2113+2112'    % 'MEG 2111'
    'MEG 2122'    'MEG 2123'    'MEG 2122+2123'    % 'MEG 2121'
    'MEG 2133'    'MEG 2132'    'MEG 2133+2132'    % 'MEG 2131'
    'MEG 2143'    'MEG 2142'    'MEG 2143+2142'    % 'MEG 2141'
    'MEG 2212'    'MEG 2213'    'MEG 2212+2213'    % 'MEG 2211'
    'MEG 2223'    'MEG 2222'    'MEG 2223+2222'    % 'MEG 2221'
    'MEG 2233'    'MEG 2232'    'MEG 2233+2232'    % 'MEG 2231'
    'MEG 2242'    'MEG 2243'    'MEG 2242+2243'    % 'MEG 2241'
    'MEG 2312'    'MEG 2313'    'MEG 2312+2313'    % 'MEG 2311'
    'MEG 2323'    'MEG 2322'    'MEG 2323+2322'    % 'MEG 2321'
    'MEG 2332'    'MEG 2333'    'MEG 2332+2333'    % 'MEG 2331'
    'MEG 2343'    'MEG 2342'    'MEG 2343+2342'    % 'MEG 2341'
    'MEG 2412'    'MEG 2413'    'MEG 2412+2413'    % 'MEG 2411'
    'MEG 2423'    'MEG 2422'    'MEG 2423+2422'    % 'MEG 2421'
    'MEG 2433'    'MEG 2432'    'MEG 2433+2432'    % 'MEG 2431'
    'MEG 2442'    'MEG 2443'    'MEG 2442+2443'    % 'MEG 2441'
    'MEG 2512'    'MEG 2513'    'MEG 2512+2513'    % 'MEG 2511'
    'MEG 2522'    'MEG 2523'    'MEG 2522+2523'    % 'MEG 2521'
    'MEG 2533'    'MEG 2532'    'MEG 2533+2532'    % 'MEG 2531'
    'MEG 2543'    'MEG 2542'    'MEG 2543+2542'    % 'MEG 2541'
    'MEG 2612'    'MEG 2613'    'MEG 2612+2613'    % 'MEG 2611'
    'MEG 2623'    'MEG 2622'    'MEG 2623+2622'    % 'MEG 2621'
