   ...
   methods
       ...
       function obj = validate(obj,data,design)
         ...
         if ~isempty(obj.init)
           ...
           rand('twister',obj.init); randn('state',obj.init);
         end
         ...
         if isscalar(obj.cvfolds) && obj.cvfolds==1 % test on training data
           ...
           for c=1:nfolds % iterate over folds
             ...
             if nfolds > 1
               ...
               obj.post = tproc.test(testdata);
               obj.design = testdesign;
             end
         ...
         % revert situation for folds
         if length(obj.design) == 1
           obj.design = obj.design{1};
         end
         
         if length(obj.procedure) == 1 && iscell(obj.procedure)
           obj.procedure = obj.procedure{1};
         end
