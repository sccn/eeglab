    ...
    methods
       ...
       function obj = train(obj,data,design)
         ...
         for i=1:size(obj.configs,1)
           ...
           validator = obj.validator; % the procedure used by the validator
           
           % set parameters
           for j=1:nv
             validator.procedure.clfmethods{obj.methodidx}.(obj.variables{j}) = obj.configs(i,j);
           end
           ...
           v = validator.validate(data,design);
