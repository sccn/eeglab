...
%
    ...
    properties
      ...
      scale  = 100;  % scale parameter; applied when prior is unspecified and in initialization
    ...
    methods
       ...
       function obj = train(obj,data,design)
           ...
           % some checking
           assert(~iscell(design) && all(design(:,1) > 0));
           assert(max(design) == 2);
           design = design(:,1);
           ...
           [obj.Gauss,terms,obj.logp,obj.convergence] = laplacedegenerate_ep(3-2*design(:,1),data,obj.prior, ...
