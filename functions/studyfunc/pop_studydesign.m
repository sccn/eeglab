...
if nargin < 3 && ~isstr(STUDY)
    ...
    cb_newvar2      = 'pop_studydesign(''newvar'', gcbf);';
    cb_editvar2     = 'pop_studydesign(''editvar'', gcbf);';
    cb_delvar2      = 'pop_studydesign(''delvar'', gcbf);';
...
%               { 'style' 'checkbox'  'string' 'Paired statistics' 'tag' 'lbpair1' 'callback' cb_lbval } ...
    ...
    geometry = { {3 16 [1 1] [2 1] } ...
                 ...
                 ...
                 {3 16 [1 5]      [1 1] } ...
                 {3 16 [1.7 5]    [1 1] } ...    % Subject variables 
