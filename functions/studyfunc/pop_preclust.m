...
if ~isstr(varargin{1}) %intial settings
    ...
    cb_help = [ 'warndlg2( strvcat(''When selecting time-based measures, only perform statistics on location measures'', ' ...
                                     '''such as dipole location or dipole density.'', ' ...
                                     '''When selecting location-based measures, only perform statistics on time-based measures.''));' ];
    ...
    {'style' 'text'       'string' 'Mixing time-based and location-based measures to cluster might result in double-dipping'} ...
