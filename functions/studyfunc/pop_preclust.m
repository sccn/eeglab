...
if ~isstr(varargin{1}) %intial settings
    ...
    help_secpca = [ 'warndlg2(strvcat(''This is the final number of dimension (otherwise use the sum'',' ...
                    '''of dimension for all selected options). See tutorial for more info''), ''Final number of dimension'');' ];
	...
	{'style' 'text'       'string' 'Final # of dim' } ...
    ...
    geomvert = [ 1 1 4 1 1 1 1 1 1 1 1 0.5 1 1 1 1];
