...
if ~isstr(varargin{1}) %intial settings
    ...
    if os.ersp_on  == 1 
        ersp = userdat2{2};
        options{end+1} = { 'ersp' 'npca' str2num(os.ersp_PCA) 'freqrange' ersp.f ...
                           'cycles' ersp.c 'alpha' ersp.a 'padratio' ersp.p ...
                           'timewindow' ersp.t 'norm' os.ersp_norm ...
    ...
    if os.itc_on  == 1 
        ersp = userdat2{2};
        options{end+1} = { 'itc' 'npca' str2num(os.ersp_PCA) 'freqrange' ersp.f ...
                           'cycles' ersp.c 'alpha' ersp.a 'padratio' ersp.p ...
                           'timewindow' ersp.t 'norm' os.ersp_norm ...
                           'weight' str2num(os.ersp_weight) };
    end       
