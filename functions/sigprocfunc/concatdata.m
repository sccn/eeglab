...
function [ datac, alllen, dims ] = concatdata(data);
    ...
    switch myndims(data{1})
        ...
        case 2,
            datac = zeros(size(data{1},1), sum(alllen));
        ...
        case 3,
            datac = zeros(size(data{1},1), size(data{1},2), sum(alllen));
        ...
        case 4,
            datac = zeros(size(data{1},1), size(data{1},2), size(data{1},3), sum(alllen));
