...
if ~isstr(data) % If NOT a 'noui' call or a callback from uicontrols
   ...
   defctrldowncom = ['ax1 = findobj(''tag'',''backeeg'',''parent'',gcbf);' ... 
             ...
             '        EEG.eventedit.WinStartPnt=g.time*EEG.srate;' ...
             '        EEG.eventedit.EpochIndex=1;' ...
             '    else;' ...
             '        EEG.eventedit.WindowIndex=g.time+1;' ...
             '        EEG.eventedit.WinStartPnt=EEG.eventedit.WindowIndex*EEG.pnts-(EEG.pnts-1);' ...
             '        EEG.eventedit.EpochIndex=ceil((EEG.eventedit.tmppos(1,1)+EEG.eventedit.WinStartPnt)/EEG.pnts);' ...
             '    end;' ...
             '    EEG.eventedit.PosLat=round(EEG.eventedit.tmppos(1,1)+EEG.eventedit.WinStartPnt);' ...
             ...
             ...
             '    YIndex=round(tmppos(1,2)/(1/(EEG.nbchan+1)));' ...
             '    EEG.eventedit.ChanIndex=(EEG.nbchan-YIndex)+1;' ...
             '    if EEG.eventedit.ChanIndex==0;' ...
             '        EEG.eventedit.ChanIndex=1;' ...
             '    end;' ...
             '    if EEG.eventedit.ChanIndex>EEG.nbchan;' ...
             '        EEG.eventedit.ChanIndex=EEG.nbchan;' ...
             '    end;' ...            
             ... % Sort events and check for event selection (if events already exist in dataset).
             '    latencies=[];' ...
             '    if ~isempty(EEG.event);' ...
             '        for i=1:length(g.events);' ...
             '            latencies(i,1)=g.events(i).latency;' ...
             '            latencies(i,2)=i;' ...
             '        end;' ...
             '        latenciesSort=sortrows(latencies,1);' ...
             '        if exist(''TmpSortedEvents'');' ...
             '            clear TmpSortedEvents;' ...
             '        end;' ...
             '        for i=1:length(g.events);' ...
             '            TmpSortedEvents(i)=g.events(latenciesSort(i,2));' ...
             '        end;' ...
             '        g=rmfield(g,''events'');' ...
             ...
             ...
             ...     % Make g.events = SortedEvents (sorted event structure.
             '        g.events=TmpSortedEvents;' ...
             '        EEG.event=g.events;' ...
             '        EEG.g.events=g.events;' ...
             ...
             ...
             ...     % Define EEG.eventedit.PosIndex: Event index at location of current button press. 
             '        EEG.eventedit.PosIndex=length(find(latencies(:,1)<=EEG.eventedit.PosLat))+1;' ...
             ...
             '        clear latenciesSort latencies TmpSortedEvents;' ...
             ...
             ...
             ...     % Check for event selection.
             '        if isfield(EEG.eventedit, ''SelEventStruct'');' ...
             '            EEG=rmfield(EEG.eventedit,''SelEventStruct'');' ...
             '        end;' ...
             '        j=0;' ...
             '        for i=1:length(g.events);' ...
             '            if abs(g.events(i).latency-EEG.eventedit.PosLat)<5;' ...
             '                j=j+1;' ...                
             '                EEG.eventedit.SelEventStruct(j).Index=i;' ...
             '                EEG.eventedit.SelEventStruct(j).Dist=abs(g.events(i).latency-round(g.tmppos(1,1)+EEG.eventedit.WinStartPnt));' ...
             '                EEG.eventedit.SelEventStruct(j).type=g.events(i).type;' ...
             '                EEG.eventedit.SelEventStruct(j).latency=g.events(i).latency;' ...
             '            end;' ...
             '        end;' ...
             '    end;' ...
             ...
             ...
             ... % If an event was selected open event editing UI.
             '    if isfield(EEG.eventedit,''SelEventStruct'');' ...
             ...
             ...
             ... % Create EEG.eventedit.SelEventList for use with "pop_EXGmrkEditEvent.m".
             '        for i=1:length(EEG.eventedit.SelEventStruct);' ...
             '            EEG.eventedit.SelEventList{i}=sprintf(''%s %s'', EEG.eventedit.SelEventStruct(i).type, num2str(EEG.eventedit.SelEventStruct(i).latency));' ...
             '        end;' ...
             ...
             ... % Select from multiple events UI.
             '        EEG = pop_EXGmrkEditEvent(EEG);' ....
             ...
             '    else;' ...
             ...
             ... % Otherwise create a new event.
             '        EEG = pop_EXGmrkAddEvent(EEG);' ...
             '    end;'  ];
