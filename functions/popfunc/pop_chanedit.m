...
if nargin < 2
	...
	while ingui
		...
		uilist   = { uilist{:}, ...
					 { }, ...
					 { },{ },{ }, {'Style', 'text', 'string', ['Channel number (of ' int2str(length(chans)) ')'], 'fontweight', 'bold', 'tag', 'chaneditscantitle' }, { },{ },{ }, ...
					...
					'set( gcbf, ''userdata'', { olduserdat{:} ''delete'', valnum }); clear olduserdat' callpart2 ] }, ...
					 ...
					 { 'Style', 'edit', 'string', '1', 'tag', 'chaneditnumval', 'callback', [callpart1 'valnum = min(str2num(get(gcbo, ''string'')),length(chantmp));' callpart2 ] }, ...
