...
if nargin < 1                 % if several arguments, assign values 
   ...
   % -----------------------
    ...
    uilist = { ...
         ...
         { 'Style', 'listbox', 'string', 'Matlab variable|ASCII text file|float32 file|Matlab .mat file', 'fontweight', 'bold', 'tag','loclist' } ...
         { 'Style', 'edit', 'string', '', 'horizontalalignment', 'left', 'tag',  'globfile' }, ...
         { 'Style', 'pushbutton', 'string', 'Browse', 'callback', [ 'tagtest = ''globfile'';' commandload commandsetfiletype ] }, ...
         ...
