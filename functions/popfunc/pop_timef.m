...
if nargin < 3
	...
	geometry = { [1 0.5 0.5] [1 0.5 0.5] [1 0.5 0.5] [0.92 0.1 0.78] [1 0.5 0.5] [1 0.9 0.1] [1] [1 1]};
    uilist = { { 'Style', 'text', 'string', fastif(typeproc, 'Channel number', 'Component number'), 'fontweight', 'bold'  } ...
			   ...
			   { 'Style', 'text', 'string',  'Coherence (set)/Phase coherence(unset)', 'fontweight', 'bold', 'tooltipstring', ['Compute linear inter-trial coherence (coher)' 10 'OR inter-trial phase coherence (phasecoher)'] } ...
	...
	result = inputgui( geometry, uilist, 'pophelp(''pop_chanedit'');', fastif(typeproc, 'Plot channel time frequency -- pop_timef()', ...
