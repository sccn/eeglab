...
if nargin < 3
    ...
    uilist = { { 'Style', 'text', 'string', fastif(typeproc, 'Channel number', 'Component number'), 'fontweight', 'bold'  } ...
			   ...
			   { 'Style', 'text', 'string',  '[set]->Linear Coher. / [unset]->Phase coher.', 'fontweight', 'bold', 'tooltipstring', ['Compute linear Inter-Trial Coherence (coher)' 10 'OR Inter-Trial phase Coherence (phasecoher)'] } ...
