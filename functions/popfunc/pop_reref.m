    ...
    if strcmpi(EEG.ref, 'common')
        if length(EEG.chanlocs) == EEG.nbchan+1
            ...
            uilist = { { 'style' 'text' 'string' 'THIS SCREEN IS USED TO ASSES INITIAL REF. AND WILL ONLY APPEAR ONCE' } ...
                       ...
                       { } ...
                       { 'style' 'text' 'string' 'Enter reference channel index(ices) if present as data channel(s):' } ...
                       ...
                       { 'style' 'checkbox' 'tag' 'reref2' 'enable' enable2 'string' 'Include old reference channel' 'callback' ...
