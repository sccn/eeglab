...
if nargin < 2                 % if several arguments, assign values 
   ...
   % -----------------------
    ...
    uilist = { ...
         ...
         ...
         { 'Style', 'text', 'string', 'Channels in data:', 'horizontalalignment', 'right', 'fontweight', 'bold' }, {},  { 'Style', 'text', 'horizontalalignment', 'center', 'string', num2str(EEG.nbchan) }, { 'Style', 'text', 'string', '(EEG.nbchan)' } ...
