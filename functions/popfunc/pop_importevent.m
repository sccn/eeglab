...
if nargin<2
        ...
        uilist = { uilist{:}, ...     
         ...
         { 'Style', 'text', 'string', 'Input field (column) names       ', 'fontweight', 'bold' } ...
         { 'Style', 'edit', 'string', '' } { 'Style', 'text', 'string', 'Ex: type latency' } };
         ...
         uilist   = { uilist{:}, ...
                ...
                { 'Style', 'text', 'string', 'Latency time unit (sec)', 'horizontalalignment', 'left' }, { 'Style', 'edit', 'string', '1' } { 'Style', 'text', 'string', 'Ex: If ms, 1E-3' },...
                { 'Style', 'text', 'string', 'Align event latencies to data events', 'horizontalalignment', 'left' }, { 'Style', 'edit', 'string', fastif(isempty(EEG.event),'NaN','0') } { 'Style', 'text', 'string', 'See help' },...
               };
