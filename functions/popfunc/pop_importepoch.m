...
if nargin < 2
    ...
    uilist = { ...
         ...
         { 'Style', 'text', 'string', '           Out of which', 'horizontalalignment', 'right', 'fontweight', 'bold' },  { 'Style', 'edit', 'string', '' }, ...
         { 'Style', 'text', 'string', 'contain latencies (ex: latency)', 'fontweight', 'bold' }, ...
         ...
...
if isempty( EEG.eventdescription )
    EEG.eventdescription{1} = 'Epoch number';
    EEG.eventdescription{2} = 'Event type';
    EEG.eventdescription{3} = 'Event latency';
end;
