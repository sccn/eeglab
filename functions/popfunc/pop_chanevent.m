...
if nargin < 2
	...
	strgui = { { 'style' 'text' 'string' 'Event channel(s)' 'tooltipstring' 'indexes of event channels' } ...
			   ...
			   { 'style' 'text' 'string' 'Transitions to extract? (up|down)' 'tooltipstring' ...
				 [ 'extract events when values of the event channel shift up' 10 ...
			   ...
			   { 'style' 'text' 'string' 'Delete event channel(s)?  (set=yes)' } ...
			   { 'style' 'checkbox' 'value' 1 } { } ...
			   { 'style' 'text' 'string' 'Delete old events if any? (set=yes)' } ...
			   { 'style' 'checkbox' 'value' 1 } { } ...
			   { 'style' 'text' 'string' 'Only one event type? (set=yes)' 'tooltipstring' ...
