%adminfunc/eeg_helpstudy.m() - Help file for EEGLAB
...
textgui( text, command,'fontsize', 15, 'fontname', 'times', 'linesperpage', 18, 'title',strvcat( 'Study processing functions', '(Click on blue text for help)'));
