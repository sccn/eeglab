...
lisboxoptions = { 'string', [ 'Show only the new trials marked for rejection by the measure selected above|' ...
                  'Show all trials marked for rejection by the measure selected above|' ...
	...
	{ 'Style', 'pushbutton', 'string', 'EEGPLOT', 'callback', cb_manual }, ...
	{ }, ...
	...
	...
	... % ---------------------------------------------------------------------------
	{ }, { 'Style', 'text', 'string', 'Find abnormal spectra', 'fontweight', 'bold' }, ...
