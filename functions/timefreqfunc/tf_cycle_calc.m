...
if isempty(Args.freqs) || isempty(Args.width)
    ...
    uigeom = {[3 2.3 1.3], [3 2.3 1.3], [3 2.3 1.3], [3 2.3 1.3]};

    uilist = {{'Style', 'text', 'String', 'Specify method:'}, ...
              {'Style', 'popupmenu', 'String', widthStr, 'Tag', 'widthpop', 'Value', widthIdx}, {}, ...
              {'Style', 'text', 'String', 'Frequency limits (e.g. 1:40):'}, ...
              {'Style', 'edit', 'String', num2str(Args.freqs(:)'), 'Tag', 'freqedit'}, {}, ...
              {'Style', 'text', 'String', 'Frequencies (Band-)width (e.g. 1 for 1 Hz):'}, ...
