...
%       'type'      = ['coher'|'phasecoher'|'phasecoher2'] Compute either
%                     linear coherence ('coher') or phase coherence ('phasecoher')
%                     also known as phase-locking factor  {default: 'phasecoher'}
%
%    Optional detrending:
