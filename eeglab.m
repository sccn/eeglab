...
second_m = uimenu( W_MAIN, 'Label', 'Edit');
	...
	uimenu( second_m, 'Label', 'Channel locations'   , 'CallBack', [ '[TMPCHAN LASTCOM] =pop_chanedit(EEG.chanlocs); if ~isempty(LASTCOM), EEG.chanlocs = TMPCHAN; clear TMPCHAN;' storecall 'end;']);
